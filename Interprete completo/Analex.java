...
public Analex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("si", this), new Integer(16));
	literals.put(new ANTLRHashString("entonces", this), new Integer(17));
	literals.put(new ANTLRHashString("escribir_cadena", this), new Integer(14));
	literals.put(new ANTLRHashString("para", this), new Integer(25));
	literals.put(new ANTLRHashString("__no", this), new Integer(46));
	literals.put(new ANTLRHashString("__y", this), new Integer(45));
	literals.put(new ANTLRHashString("hasta", this), new Integer(24));
	literals.put(new ANTLRHashString("fin_mientras", this), new Integer(22));
	literals.put(new ANTLRHashString("mientras", this), new Integer(20));
	literals.put(new ANTLRHashString("borrar", this), new Integer(9));
	literals.put(new ANTLRHashString("repetir", this), new Integer(23));
	literals.put(new ANTLRHashString("hacer", this), new Integer(21));
	literals.put(new ANTLRHashString("lugar", this), new Integer(5));
	literals.put(new ANTLRHashString("leer", this), new Integer(10));
	literals.put(new ANTLRHashString("desde", this), new Integer(26));
	literals.put(new ANTLRHashString("leer_cadena", this), new Integer(12));
	literals.put(new ANTLRHashString("fin_para", this), new Integer(28));
	literals.put(new ANTLRHashString("__o", this), new Integer(44));
	literals.put(new ANTLRHashString("escribir", this), new Integer(13));
	literals.put(new ANTLRHashString("si_no", this), new Integer(18));
	literals.put(new ANTLRHashString("fin_si", this), new Integer(19));
	literals.put(new ANTLRHashString("paso", this), new Integer(27));
}
