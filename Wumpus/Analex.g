...
tokens
{
	...
	CONFIG="configuraJuego";
	FIN_CONFIG="fin_configuraJuego";
	JUEGO="jugar";
	FIN_JUEGO="fin_jugar";

	SET_TABLERO="setTablero";
	SET_INICIO="setInicio";
	SET_FIN="setFin";
	SET_TESORO="setTesoro";
	SET_WUMPUS="setWumpus";
	SET_POZO="setPozo";
	SET_FLECHA="setFlecha";
	SET_FLECHAS_INI="setFlechasIni";
	SET_VIDAS_INI="setVidasIni";
	SET_AMBROSIA="setAmbrosia";
	SET_MINA="setMina";
	MOSTRAR_TABLERO="mostrarTablero";
	REINICIAR="reiniciar";
	

	MOVER_JUGADOR="moverJugador";
	IZQUIERDA="izquierda";
	DERECHA="derecha";
	ARRIBA="arriba";
	ABAJO="abajo";
	COGER_FLECHA="cogerFlecha";
	DISPARAR="disparar";
	BEBER="beber";
	MOSTRAR_FLECHAS="mostrarFlechas";
	MOSTRAR_VIDAS="mostrarVidas";
